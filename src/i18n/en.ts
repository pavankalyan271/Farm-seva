...
export const en = {
  ...
  farmer_cancel_request: "Cancel Request",
    owner_mark_all_read: "Mark all as read",
  owner_view_request: "View Request",
  owner_mark_read: "Mark read",
  owner_no_new_notifications: "No new notifications.",
  owner_arrival: "Arrival",
  owner_arrival_date: "Arrival date",
  owner_arrival_time: "Arrival time",
  owner_arrival_not_provided: "Arrival date and time not yet provided.",
  owner_update_view: "Update / View",
  owner_completing: "Completing…",
  owner_no_actions: "No actions available",
  owner_mark_unavailable: "Mark Unavailable",
  owner_mark_available: "Mark Available",
  owner_scheduled: "Scheduled",
  owner_date: "Date",
  owner_time: "Time",
  owner_date_time_not_provided: "Date/time not provided",
  owner_request_from: "Request from",
  owner_save: "Save",
};
