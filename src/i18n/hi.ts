...
export const hi: typeof import("./en").en = {
  ...
  farmer_role_label: "भूमिका",
  farmer_role_value: "किसान",
  farmer_mark_all_read: "सभी को पढ़ा हुआ चिह्नित करें",
  farmer_view_request: "अनुरोध देखें",
  farmer_mark_read: "पढ़ा हुआ चिह्नित करें",
  farmer_registered_location: "पंजीकृत स्थान:",
  farmer_current_location: "वर्तमान स्थान:",
  farmer_location_not_detected: "स्थान का पता नहीं चला।",
  farmer_nearby_machinery_placeholder: "पास की मशीनरी",
  farmer_nearby_machinery_title: "पास की मशीनरी",
  farmer_your_location: "आपका स्थान:",
  farmer_machinery_type: "मशीनरी प्रकार",
  farmer_all_types: "सभी प्रकार",
  farmer_availability: "उपलब्धता",
  farmer_available: "उपलब्ध",
  farmer_all: "सभी",
  farmer_nearby: "दूरी",
  farmer_within_5_km: "5 किमी के भीतर",
  farmer_within_10_km: "10 किमी के भीतर",
  farmer_within_25_km: "25 किमी के भीतर",
  farmer_within_50_km: "50 किमी के भीतर",
  farmer_search: "खोजें",
  farmer_no_machinery_registered: "अभी तक कोई मशीनरी पंजीकृत नहीं है।",
  farmer_no_machinery_found: "आपकी खोज से मेल खाने वाली मशीनरी नहीं मिली।",
  farmer_owner: "मालिक:",
  farmer_location: "स्थान:",
  farmer_currently_unavailable: "अभी उपलब्ध नहीं है",
  farmer_request_machinery_title: "मशीनरी का अनुरोध करें",
  farmer_owner_name: "मालिक का नाम:",
  farmer_select_machine: "मशीन चुनें",
  farmer_no_machines_owner: "इस मालिक के पास कोई मशीन उपलब्ध नहीं है।",
  farmer_select_service: "सेवा चुनें",
  farmer_hours: "घंटे",
  farmer_estimated_total_label: "अनुमानित कुल:",
  farmer_select_service_estimate: "अनुमानित कीमत देखने के लिए सेवा चुनें।",
  farmer_send_request: "अनुरोध भेजें",
  farmer_cancel: "रद्द करें",
  farmer_owner_machinery_details: "मालिक और मशीनरी विवरण",
  farmer_phone: "फ़ोन:",
  farmer_inventory: "मशीनरी:",
  farmer_request_this_machine: "इस मशीन का अनुरोध करें",
  farmer_unavailable: "उपलब्ध नहीं",
  farmer_close: "बंद करें",
  farmer_my_bookings: "मेरी बुकिंग्स",
  farmer_service: "सेवा:",
  farmer_hours_label: "घंटे:",
  farmer_requested: "अनुरोध किया गया:",
  farmer_machinery_confirmed: "मशीनरी अनुरोध स्वीकार किया गया",
  farmer_arrival_date_time_not_provided: "आगमन की तारीख/समय उपलब्ध नहीं है।",
  farmer_job_completed: "कार्य पूरा हुआ",
  farmer_status: "स्थिति:",
  farmer_my_requests: "मेरे अनुरोध",
  farmer_empty_requests: "अभी तक कोई अनुरोध नहीं है।",
  farmer_cancel_request: "अनुरोध रद्द करें",
    // Owner Dashboard additional translations
  owner_mark_all_read: "सभी को पढ़ा हुआ चिह्नित करें",
  owner_view_request: "अनुरोध देखें",
  owner_mark_read: "पढ़ा हुआ चिह्नित करें",
  owner_no_new_notifications: "कोई नई सूचना नहीं है।",
  owner_arrival: "आगमन",
  owner_arrival_date: "आगमन की तारीख",
  owner_arrival_time: "आगमन का समय",
  owner_arrival_not_provided: "आगमन की तारीख और समय अभी उपलब्ध नहीं है।",
  owner_update_view: "अपडेट / देखें",
  owner_completing: "पूरा किया जा रहा है…",
  owner_no_actions: "कोई कार्रवाई उपलब्ध नहीं है",
  owner_mark_unavailable: "अनुपलब्ध चिह्नित करें",
  owner_mark_available: "उपलब्ध चिह्नित करें",
  owner_scheduled: "निर्धारित",
  owner_date: "तारीख",
  owner_time: "समय",
  owner_date_time_not_provided: "तारीख/समय उपलब्ध नहीं है",
  owner_request_from: "अनुरोधकर्ता",
  owner_save: "सहेजें",
};