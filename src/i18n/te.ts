...
export const te: typeof import("./en").en = {
  ...
  owner_mark_all_read: "అన్నింటినీ చదివినట్లు గుర్తించండి",
  owner_view_request: "అభ్యర్థనను చూడండి",
  owner_mark_read: "చదివినట్లు గుర్తించండి",
  owner_no_new_notifications: "కొత్త నోటిఫికేషన్లు లేవు.",
  owner_arrival: "రాక",
  owner_arrival_date: "రాక తేదీ",
  owner_arrival_time: "రాక సమయం",
  owner_arrival_not_provided: "రాక తేదీ మరియు సమయం ఇంకా అందించబడలేదు.",
  owner_update_view: "నవీకరించండి / చూడండి",
  owner_completing: "పూర్తి చేస్తోంది…",
  owner_no_actions: "చర్యలు అందుబాటులో లేవు",
  owner_mark_unavailable: "అందుబాటులో లేదని గుర్తించండి",
  owner_mark_available: "అందుబాటులో ఉందని గుర్తించండి",
  owner_scheduled: "షెడ్యూల్ చేయబడింది",
  owner_date: "తేదీ",
  owner_time: "సమయం",
  owner_date_time_not_provided: "తేదీ/సమయం అందించబడలేదు",
  owner_request_from: "అభ్యర్థన పంపినవారు",
  owner_save: "సేవ్ చేయండి",
